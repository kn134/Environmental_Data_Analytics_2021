...
Rainfall_BR_processed <-
  ...
  separate(Statistics,c("Null","Month","Null2")," ") %>% #separating column stats into 3 columns; " " specificies the separater of a space
  mutate( Date = my(paste0(Month,"-",Year))) %>% #month year my
