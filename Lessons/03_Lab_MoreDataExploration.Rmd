...
matrix1[4, ] # access row number 4
matrix1[ , 3] # access column number 3
matrix1[c(12, 14)] # elements 12, 13, 14
matrix1[c(12:14)] #
matrix1[2:4, 1:3] #
...
weather_high_F <- c(49, 52, 50, 52, 52, 52, 51, 41, 42, 36)

weather_low_F <- c(25, 40, 28, 33, 28, 35, 33, 26, 22, 20)
...
weather_high_C <- F_to_C(weather_high_F)
weather_low_C <- F_to_C(weather_low_F)
